...
class ABC:
    ...
    def joining_tables(self,t1, t2, t3, t4, t5, t6):
    ...
    def final_2079_data(self):
        ...
        final_2079 = self.joining_tables(barley_2079, maize_2079, buckwheat_2079, millet_2079, wheat_2079, paddy_2079)
    ...
    def data_2078(self):
        ...
        final_2078 = self.joining_tables(barley_2078, maize_2078, buckwheat_2078, millet_2078, wheat_2078, paddy_2078)
    ...
    def data_2077(self):
        ...
        final_2077 = self.joining_tables(barley_2077, maize_2077, buckwheat_2077, millet_2077, wheat_2077, paddy_2077)
    ...
    def data_2076(self):
        ...
        final_2076 = self.joining_tables(barley_2076, maize_2076, buckwheat_2076, millet_2076, wheat_2076, paddy_2076)
